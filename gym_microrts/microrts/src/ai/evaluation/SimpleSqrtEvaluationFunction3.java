 ...
 * @author santi
 * 
 * This function uses the same base evaluation as SimpleSqrtEvaluationFunction 
 * and SimpleSqrtEvaluationFunction2, but returns the (proportion*2)-1 of the 
 * total score on the board that belongs to one player.
